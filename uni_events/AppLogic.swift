        ...
        Alamofire.request(.GET, url).responseJSON { (response) in
            ...
            if let data = response.data {
                ...
                do {
                    ...
                    let readableJSON = try NSJSONSerialization.JSONObjectWithData(data, options: .MutableContainers) as? [[String : AnyObject]]
...
//        do {
//            
//            let readableJSON = try NSJSONSerialization.JSONObjectWithData(JSONData, options: .MutableContainers) as? [[String : AnyObject]]
//            
//            for dict in readableJSON! {
//                
//                let newEvent = Event()
...
//    }
    ...
    static func fetchEvents(completionHandler : (events: [[Event]]) -> Void) {
        ...
        if let url = NSURL(string: "\(App.Memory.apiUrl)/api/events") {
